...
class pkt_rcv_strip(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0.set_center_freq(5.8e9, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/maxwell/grcPackage/Bpsk-main/output.tmp', False)
