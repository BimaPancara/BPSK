...
class pkt_rcv(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.sps = sps = 4
        self.samp_rate_rx = samp_rate_rx = 48000
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(
                interpolation=1,
                decimation=((int)(usrp_rate/samp_rate_rx)),
                taps=[],
                fractional_bw=0)
        ...
        self.osmosdr_source_0.set_center_freq(2.7e9, 0)
        self.osmosdr_source_0.set_freq_corr(0, 0)
        self.osmosdr_source_0.set_dc_offset_mode(2, 0)
        self.osmosdr_source_0.set_iq_balance_mode(0, 0)
        self.osmosdr_source_0.set_gain_mode(False, 0)
        self.osmosdr_source_0.set_gain(5, 0)
        self.osmosdr_source_0.set_if_gain(48, 0)
        self.osmosdr_source_0.set_bb_gain(34, 0)
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, samp_rate_rx, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate_rx) if "auto" == "time" else int(0.1), 1) )
        self.blocks_repack_bits_bb_1_0 = blocks.repack_bits_bb(1, 8, "packet_len", False, gr.GR_MSB_FIRST)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, './Received.tmp', False)
    ...
    def set_samp_rate_rx(self, samp_rate_rx):
        ...
        self.blocks_throttle2_0.set_sample_rate(self.samp_rate_rx)
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate_rx)
        self.qtgui_sink_x_0.set_frequency_range(0, self.samp_rate_rx)
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.samp_rate_rx)
        self.qtgui_time_sink_x_0_2.set_samp_rate(self.samp_rate_rx)
