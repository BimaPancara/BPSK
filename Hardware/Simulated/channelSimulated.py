...
class channelSimulated(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Simulated Channel", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simulated Channel")
        ...
        self.settings = Qt.QSettings("GNU Radio", "channelSimulated")
...
def main(top_block_cls=channelSimulated, options=None):
