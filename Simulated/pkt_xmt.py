...
class pkt_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='Kirim.txt'):
        ...
        self.osmosdr_sink_0.set_sample_rate(usrp_rate)
        self.osmosdr_sink_0.set_center_freq(2.7e9, 0)
        self.osmosdr_sink_0.set_freq_corr(0, 0)
        self.osmosdr_sink_0.set_gain(10, 0)
        self.osmosdr_sink_0.set_if_gain(20, 0)
        self.osmosdr_sink_0.set_bb_gain(20, 0)
        self.osmosdr_sink_0.set_antenna('', 0)
        self.osmosdr_sink_0.set_bandwidth(500e6, 0)
        ...
        self.connect((self.fft_filter_xxx_0_0_0, 0), (self.qtgui_const_sink_x_0, 0))
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.mmse_resampler_xx_0.set_resamp_ratio((1.0/((self.usrp_rate/self.samp_rate)*self.rs_ratio)))
        self.osmosdr_sink_0.set_sample_rate(self.usrp_rate)
...
def argument_parser():
    ...
    parser.add_argument(
        "--InFile", dest="InFile", type=str, default='Kirim.txt',
